...
namespace WebApi.Migration.Demo.Migrations
{
    ...
    [Migration("20170513070358_addFk8")]
    partial class addFk8
    {
            ...
            modelBuilder.Entity("WebApi.Migration.Demo.Model.Lodging", b =>
                {
                    ...
                    b.Property<int?>("PrimaryContactForId");

                    b.Property<int?>("PrimaryContactId");

                    b.Property<int?>("SecondContactForId");
                    ...
                    b.HasIndex("PrimaryContactForId");

                    b.HasIndex("PrimaryContactId");

                    b.HasIndex("SecondContactForId");
            ...
            modelBuilder.Entity("WebApi.Migration.Demo.Model.Lodging", b =>
                {
                    ...
                    b.HasOne("WebApi.Migration.Demo.Model.Person", "PrimaryContactFor")
                        .WithMany()
                        .HasForeignKey("PrimaryContactForId");

                    b.HasOne("WebApi.Migration.Demo.Model.Person", "PrimaryContact")
                        .WithMany()
                        .HasForeignKey("PrimaryContactId");

                    b.HasOne("WebApi.Migration.Demo.Model.Person", "SecondContactFor")
                        .WithMany()
                        .HasForeignKey("SecondContactForId");
