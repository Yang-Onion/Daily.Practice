...
namespace WebApi.Migration.Demo.Migrations
{
    ...
    [Migration("20170513064436_addFk3")]
    partial class addFk3
    {
            ...
            modelBuilder.Entity("WebApi.Migration.Demo.Model.Lodging", b =>
                {
                    ...
                    b.Property<int>("DestinationDestinationId");
                    ...
                    b.HasIndex("DestinationDestinationId");
            ...
            modelBuilder.Entity("WebApi.Migration.Demo.Model.Lodging", b =>
                {
                    b.HasOne("WebApi.Migration.Demo.Model.Destination", "Target")
                        .WithMany("Lodgings")
                        .HasForeignKey("DestinationDestinationId")
